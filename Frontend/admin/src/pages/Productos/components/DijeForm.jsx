...
export default function DijeForm({ type = "create", initialData = {} }) {
  const [formData, setFormData] = useState({
    ...
    tipo_dije: initialData.tipo_dije || "otros",
    photo: null,
    photo2: null,
    photo3: null,
    ...initialData,
    ...
    <form
      ...
      <div className="flex justify-end space-x-3">
        ...
        <button
          ...
          {type === "create" ? "Crear Dije" : "Actualizar Dije"}
        </button>
      </div>
    </form>
  );
