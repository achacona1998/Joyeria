...
export default function PircingForm({ type = "create", initialData = {} }) {
  const [formData, setFormData] = useState({
    ...
    lugar_de_uso: initialData.lugar_de_uso || "otro",
    photo: null,
    photo2: null,
    photo3: null,
    ...initialData,
    ...
    <form
      ...
      <div className="flex justify-end space-x-3">
        ...
        <button
          ...
          {type === "create" ? "Crear Pircing" : "Actualizar Pircing"}
        </button>
      </div>
    </form>
  );
